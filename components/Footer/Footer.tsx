...
const Container = tw.div`lg:w-[1316px] lg:mx-auto flex justify-between`;
const LeftBlockFooter = tw.div``;
const RightBlockFooter = tw.div``;
const ContainerBottom = tw.div`flex justify-between lg:w-[1316px] w-auto lg:mx-auto mx-[20px]`;
